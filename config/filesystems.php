    ...
    */
    ...
    'disks' => [
        ...
        'property' => [
            'driver' => 'local',
            'root' => public_path(),  // حفظ الملفات في public/uploads/categories
            'url' => env('APP_URL') . '/uploads/property',  // رابط الوصول سيكون http://your-domain.com/uploads/categories
            'visibility' => 'public',
            'throw' => false,
        ],
        // ✅ إضافة disk جديد لصور الملكية
        'ownership_image' => [
            'driver' => 'local',
            'root' => public_path(),
            'url' => env('APP_URL') . '/uploads/ownership_image',
            'visibility' => 'public',
            'throw' => false,
        ],
